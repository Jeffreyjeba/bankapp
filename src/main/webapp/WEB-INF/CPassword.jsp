        ...
        <div class="password">
            <form action="changePassword" method="post">
                ...
                <tr><th><h3>CHANGE PASSWORD</h3></th></tr>
                 <tr><td><input name="oldPass" type="password" placeholder="Old Password"></td></tr>
                 <tr><td><input name="newPass" type="password"placeholder="New Password"></td></tr>
                 <tr><td><input name="confoPass" type="password"placeholder="Reenter New Password"></td></tr>
